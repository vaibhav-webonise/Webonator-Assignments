...
public class Cellphone {
    ...
    void doCalculate() {
        ...
        do {
            ...
            switch (choiceInput) {
                case 1:
                    System.out.print(" Addition result: " + (numberOne + numberTwo));
                    break;
                case 2:
                    System.out.print(" Substraction result: " + (numberOne - numberTwo));
                    break;
                case 3:
                    System.out.print(" Multiplication result: " + (numberOne * numberTwo));
                    break;
                case 4:
                    System.out.print(" Division result: " + (numberOne / numberTwo));
                    break;
                default:
