...
public class CellphoneHandler {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (brandChoice) {
                case 1:
                    Samsung samsungObject = new Samsung();
                    System.out.println("\n Samsung features...");
                    ...
                    switch (samsungChoice) {
                        case 1:
                            samsungObject.samsungPay();
                            break;
                        case 2:
                            samsungObject.doCall();
                            break;
                        case 3:
                            samsungObject.doMessage();
                            break;
                        case 4:
                            samsungObject.doCalculate();
                            break;
                    }
                    break;
                ...
                case 2:
                    ...
                    switch (iphoneChoice) {
                        case 1:
                            iphoneObject.callSiri();
                            break;
                        case 2:
                            iphoneObject.doCall();
                            break;
                        case 3:
                            iphoneObject.doMessage();
                            break;
                        case 4:
                            iphoneObject.doCalculate();
                            break;
                    }
                    break;
                default:
